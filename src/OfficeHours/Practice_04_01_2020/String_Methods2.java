...
public class String_Methods2 {
    public static void main(String[] args) {
        ...
        System.out.println("========================================================================");
        //equals(str); checks if the two string of the text are equal or not, return boolean
        //equalsIgnoreCase(str);checks if the two string of the text are equal or not,and ignore the case sensitivity, return boolean
       ...
       System.out.println(s1.equals(s2));//true
        ...
        System.out.println(s3.equalsIgnoreCase(s1));// true ignore case sensitivity
